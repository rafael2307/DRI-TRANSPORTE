        ...
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.subtitle}>Ingresa tu número para continuar</Text>
                </View>
                ...
                <Text style={styles.termsText}>
                    Al continuar, aceptas nuestros <Text style={styles.link}>Términos y Condiciones</Text> y la <Text style={styles.link}>Política de Privacidad</Text>.
                </Text>
            </ScrollView>
        </SafeAreaView>
    );
...
const styles = StyleSheet.create({
    ...
    countryCode: {
        ...
        borderRightWidth: 1,
        borderRightColor: theme.colors.glass,
