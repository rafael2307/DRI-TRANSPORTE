...
import { ChevronLeft, Calendar, MapPin, Clock, CreditCard } from 'lucide-react-native';

const TripItem = ({ trip }) => (
    <GlassCard style={styles.tripCard}>
        <View style={styles.tripHeader}>
            <View style={styles.dateContainer}>
                <Calendar color={theme.colors.primary[0]} size={16} />
        ...
        <View style={styles.tripFooter}>
            ...
            <View style={styles.footerItem}>
                <CreditCard color={theme.colors.text.secondary} size={14} />
                <Text style={styles.footerText}>${trip.fare.toLocaleString()}</Text>
            </View>
        </View>
    </GlassCard>
);
...
export default function HistoryScreen({ navigation }) {
    const [trips] = useState([
        { id: '1', date: 'Hoy, 2:30 PM', status: 'COMPLETED', pickup: 'Calle 100 #15-20', destination: 'Aeropuerto El Dorado', duration: '45 min', fare: 35000 },
        { id: '2', date: 'Ayer, 9:15 AM', status: 'COMPLETED', pickup: 'Centro Comercial Andino', destination: 'Plaza de Bolívar', duration: '20 min', fare: 12500 },
        { id: '3', date: '15 Feb, 11:00 PM', status: 'CANCELLED', pickup: 'Zona T', destination: 'Cedritos', duration: '0 min', fare: 0 },
    ]);
